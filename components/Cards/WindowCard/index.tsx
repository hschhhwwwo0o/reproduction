  ...
  return (
    <>
      <motion.div className="max-w-2xl">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 2, delay: 0.8 }}>
        ...
        <div className="mt-8 flex flex-col gap-5">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.7 }}>
            <Paragraph>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 0.9 }} transition={{ duration: 2, delay: 0.7 }}>
